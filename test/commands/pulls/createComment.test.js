...
const yargsModule = require("../../../src/commands/pulls/createComment")
...
describe("Yargs", () => {
	test("`pulls createComment` command module exports an object that can be used by yargs", () => {
		expect(yargsModule).toEqual(
			expect.objectContaining({
				command: expect.stringMatching("pulls createComment"),
	...
	test("yargs can load the `pulls createComment` command without any errors or warnings", () => {
		expect(() => {
			yargs.command(
				yargsModule.command,
				yargsModule.desc,
